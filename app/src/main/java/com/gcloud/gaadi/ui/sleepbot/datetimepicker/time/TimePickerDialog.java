...
public class TimePickerDialog extends DialogFragment implements RadialPickerLayout.OnValueSelectedListener {
    ...
    public void setOnTimeSetListener(OnTimeSetListener callback, TimeType timeType) {
        mCallback = callback;
        mTimeType = timeType;
    }
    ...
    public interface OnTimeSetListener {
        ...
        void onTimeSet(RadialPickerLayout view, int hourOfDay, int minute, TimeType timeType);
    }
