...
import com.gcloud.gaadi.ui.fourmob.datetimepicker.Utils;
...
public class DatePickerDialog extends DialogFragment implements View.OnClickListener, DatePickerController {
    ...
    private void onDoneButtonClick() {
        ...
        if (mCallBack != null) {
            if (mDateType != null) {
                mCallBack.onDateSet(this, mCalendar.get(Calendar.YEAR), mCalendar.get(Calendar.MONTH), mCalendar.get(Calendar.DAY_OF_MONTH), mDateType);
            } else {
    ...
    public void setOnDateSetListener(OnDateSetListener onDateSetListener, DateType dateType) {
        mCallBack = onDateSetListener;
        mDateType = dateType;
    }
    ...
    public static abstract interface OnDateSetListener {
        ...
        public abstract void onDateSet(DatePickerDialog datePickerDialog, int year, int month, int day, DateType dateType);
    }
}