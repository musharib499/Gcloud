...
public class SellerFilterActivity extends AppCompatActivity implements View.OnClickListener {

    public static final String CHANGE_LIST_ITEM = "changeListItem";
    final public static ArrayList<String> list = new ArrayList<>(
            Arrays.asList(new String[]{"Verified", "Make", "Model", "Price", "Status", "Lead Source"}));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.apply_filter:
                ProgressDialog.show(this, "", getString(R.string.please_wait, true, false));
