...
public class SimilarCarsFragment extends Fragment implements
    ...
    private SimilarCarsAdapter similarCarAdapter;
...
private HashMap<String, String> params = new HashMap<String, String>();
    ...
    private void makeSimlarCarsRequest(final boolean showFullPageError,
        ...
        params.put(Constants.D2D_TAB, Constants.SIMILAR_CAR);
    ...
    private void initializeList(InventoriesModel response) {
        ...
        listView.setOnScrollListener(new EndlessScrollListener() {
            ...
            public void onEndlessScroll(int pageNo) {
                if (isNextPossible) {
                    listView.addFooterView(footerView);
                    makeSimlarCarsRequest(false, pageNo);
                }
            }
		 ...
		 * getActivity() .findViewById(R.id.active_refresh_layout);
        ...
        similarCarAdapter = new SimilarCarsAdapter(getFragmentActivity(),
                response.getInventories(), leadMobilenum, leadName, Constants.CLOSELIST_SIMILAR);
        listView.setAdapter(similarCarAdapter);
    }
    ...
    private void showAddLeadLayout(boolean showFullPageError) {
        ...
        errorMessage = (TextView) view.findViewById(R.id.errorMessage);
        errorMessage.setText("No Similar Cars");
    ...
    public void onOpenListItem(OpenListItemEvent event) {
        ...
        if (source == Constants.CLOSELIST_SIMILAR)
    ...
    public void onShareTypeSelected(ShareTypeEvent event) {
        ...
        if(fragmentType==Constants.OPENLIST_SIMILAR) {
    ...
    public void onContactSelected(ContactListItem contactListItem, String shareText, ShareType shareType, String carId, String imageUrl) {
        ...
        if (shareType == ShareType.WHATSAPP) {
            ...
            try {
                mGShareToUtil.sendSMSHelp(contactListItem.getContactNumber(), shareText, carId);
            } catch (Exception e) {
                CommonUtils.showToast(getFragmentActivity(), "Could not send SMS. Invalid number.", Toast.LENGTH_SHORT);
            }
