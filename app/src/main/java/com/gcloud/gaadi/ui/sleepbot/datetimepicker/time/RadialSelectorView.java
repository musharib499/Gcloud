...
public class RadialSelectorView extends View {
    ...
    public void initialize(Context context, boolean is24HourMode, boolean hasInnerCircle,
        ...
        if (mIsInitialized) {
            GCLog.e("This RadialSelectorView may only be initialized once.");
            return;
        }

        Resources res = context.getResources();

        int blue = res.getColor(R.color.orange);
    ...
    public ObjectAnimator getDisappearAnimator() {
        if (!mIsInitialized || !mDrawValuesReady) {
            GCLog.e("RadialSelectorView was not ready for animation.");
            return null;
        }
