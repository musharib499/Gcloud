package com.gcloud.gaadi.ui.sleepbot.datetimepicker.time;
...
public class RadialPickerLayout extends FrameLayout implements OnTouchListener {
    ...
    public void initialize(Context context, int initialHoursOfDay, int initialMinutes,
        ...
        if (mTimeInitialized) {
            GCLog.e("Time has already been initialized.");
            return;
        }
    ...
    public int getCurrentItemShowing() {
        if (mCurrentItemShowing != HOUR_INDEX && mCurrentItemShowing != MINUTE_INDEX) {
            GCLog.e("Current item showing was unfortunately set to " + mCurrentItemShowing);
            return -1;
        }
    ...
    public void setCurrentItemShowing(int index, boolean animate) {
        if (index != HOUR_INDEX && index != MINUTE_INDEX) {
            GCLog.e("TimePicker does not support view at index " + index);
            return;
        }
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (!mInputEnabled) {
                    ...
                    GCLog.e("Input was disabled, but received ACTION_MOVE.");
                    return true;
                }
