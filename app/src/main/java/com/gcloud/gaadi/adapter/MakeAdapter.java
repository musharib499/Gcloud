 ...
 */
public class MakeAdapter extends CursorAdapter {
    ...
    public MakeAdapter(Context context, Cursor cursor) {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        String version = cursor.getString(cursor.getColumnIndex(MakeModelVersionDB.MAKENAME));
