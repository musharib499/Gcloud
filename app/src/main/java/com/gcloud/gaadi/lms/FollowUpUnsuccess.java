 ...
 */
public class FollowUpUnsuccess extends DialogFragment implements View.OnClickListener, DialogInterface.OnKeyListener {
    ...
    public static FollowUpUnsuccess getInstance(Bundle data, Activity activity, LMSInterface listener) {
        FollowUpUnsuccess fragment = new FollowUpUnsuccess();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View dialogLayout = inflater.inflate(R.layout.lms_follow_up_unsuccess, null);
