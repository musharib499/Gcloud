 ...
 */
public class WalkInSuccessNo extends DialogFragment implements View.OnClickListener, DialogInterface.OnKeyListener {

    private static final String TAG = "WalkInSuccessNo";
...
//    private String scheduleStatus;
    ...
    public static WalkInSuccessNo getInstance(Bundle data,
                                              Activity activity,
                                              LMSInterface listener) {
        WalkInSuccessNo fragment = new WalkInSuccessNo();
...
//        fragment.scheduleStatus = scheduleStatus;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View dialogLayout = inflater.inflate(R.layout.lms_walk_in_success_no, null);
        ((TextView) dialogLayout.findViewById(R.id.title)).setText(CommonUtils.getReplacementString(getActivity(),
                R.string.walkIn_callSuccessNo,
                leadData.getName()));
        ...
        AlertDialog dialog = new AlertDialog.Builder(getFragmentActivity())
                //.setTitle(CommonUtils.getReplacementString(getActivity(), R.string.walkIn_callSuccessNo, leadData.getName()))
